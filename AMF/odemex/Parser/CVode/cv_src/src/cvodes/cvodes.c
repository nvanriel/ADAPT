...
int CVodeSetMaxTime( void *cvode_mem, double maxTime )
{
    CVodeMem cv_mem;
          ...
          realtype *tret, int itask )
{
  ...
  loop {
      ...
      if ( difftime( tEnd, tStart ) > cv_mem->tMax ) { /* Added by Joep Vanlier */
        fprintf(stderr, "Simulation time exceeded: t=%e, dt=%e\n", tn, h );
